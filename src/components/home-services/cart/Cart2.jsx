...
const Cart2 = () => {
  ...
  return (
    <div className="flex h-screen overflow-y-auto bg-slate-950 text-slate-100">
          ...
          <>
            ...
            >
              ...
              <div className="flex flex-col ml-6">
                ...
                <p className="text-sm text-slate-300 mt-4">{product.size}</p>
              </div>
      ...
      <div className="w-2/6 ml-6 mr-6 mt-36">
        <div className="bg-slate-400 bg-opacity-10 p-8 rounded-md">
          <h2 className="text-xl mb-4 font-semibold text-slate-100">
            Order Summary
          </h2>
          <div className="mb-4">
        ...
        <div className="mt-4">
          ...
          <div className="flex">
            <input
              ...
              className="mt-1 p-2 rounded bg-slate-700"
            />
            <button
