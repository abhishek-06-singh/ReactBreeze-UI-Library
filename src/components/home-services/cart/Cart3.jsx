    ...
    <div className="flex flex-col items-center h-screen overflow-y-auto relative">
      ...
      <div className="w-3/5 m-6 mb-10 text-center z-50">
        ...
        {cart.map((product) => (
          <div
            key={product.id}
            className="flex items-start mb-4 rounded-2xl p-2 z-50"
          >
      ...
      <div className="w-4/6 text-center">
        ...
        {/* Promo Code Section */}
        <div className="mt-6 text-center bg-slate-50 mb-20 p-6 rounded-md shadow-md">
          <label className="block text-md font-medium text-gray-700 mb-2 text-left">
            Promo Code
          </label>
          <div className="flex items-center">
            <div className="relative w-full">
              <input
                ...
                className="p-2 pl-10 border rounded-l-md w-full focus:outline-none focus:ring focus:border-indigo-500"
              />
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <AiOutlineTag className="text-indigo-800 font-bold" />
              </div>
            </div>
            <button
