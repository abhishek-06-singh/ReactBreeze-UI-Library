...
const AddAddress2 = ({ isVisible, title, handleClose }) => {
  ...
  return (
    <div className="bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-100 via-indigo-300 to-pink-300 h-screen flex justify-center items-center">
      <div className="w-3/5 bg-gray-900 rounded-lg p-3 pb-2 relative text-white">
        {/* Cross Icon */}
        <button
          type="button"
          className="ml-auto -mx-1.5 -my-1.5 bg-gray-800 justify-center items-center flex-shrink-0 text-gray-400 hover:text-gray-300 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-slate-800 inline-flex h-8 w-8 absolute top-4 right-4"
                ...
                <div className="mt-0 relative">
                  <input
                    {...getInputProps({
                      ...
                      className:
                        "w-full md:w-2/3 mx-auto  rounded px-2 py-1 bg-slate-800",
                    })}
                  />
                  {loadingSuggestions && (
                  ...
                  {suggestions.length > 0 && (
                    <div
                      className="max-h-40 overflow-y-auto p-2 bg-gray-700 border border-gray-400 rounded absolute left-0 right-0 transition-opacity"
                      style={{
                    ...
                    >
                      {suggestions.map((suggestion, index) => (
                        <div
                          ...
                          className="cursor-pointer hover-bg-gray-600 p-1 pl-4 font-semibold text-left border-b"
            ...
            <div className="w-full md-w-1/2 pl-4 mt-4">
              <div className="mb-4">
                ...
                <input
                  ...
                  id="fa"
                  value={address}
                  className="w-80  bg-slate-800 rounded px-2 py-1 mb-4"
              ...
              <div className="mb-4 text-center mt-2">
                ...
                <button
                  className={`w-32 px-5 py-1 rounded-full mr-4 border ${
                    type && "bg-indigo-900 text-indigo-100 border-indigo-500"
                  }`}
              ...
              <button
                className="bg-indigo-500 w-80 mx-auto hover-bg-indigo-700 text-white py-2 px-7 rounded mt-16 ml-2"
