  ...
  return (
    <div className="bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-100 via-indigo-300 to-pink-300 h-screen flex justify-center items-center">
      <div className="w-3/5 bg-white rounded-2xl shadow-lg relative overflow-hidden">
        ...
        <div className="text-xl font-bold mb-6 text-center text-slate-800">
          Average Arrival Time: 10:00 mins
        </div>

        {/* Submit Button */}
        <div className="relative w-full flex flex-col items-center mt-4 mb-4">
          <button className="bg-indigo-600 hover:bg-indigo-800 h-12 w-60 text-white rounded-full transition-all duration-300">
            Submit
          </button>
        </div>
      </div>
