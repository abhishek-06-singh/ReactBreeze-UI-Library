...
const Toast4 = () => {
  return (
    <div className="flex items-center justify-center h-96 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-100 via-indigo-300 to-pink-300">
      <div
        className="w-full max-w-md p-6 text-gray-300 bg-gray-800 rounded-lg shadow"
        role="alert"
      >
        <div className="flex items-center mb-3">
          <span className="mb-1 text-sm font-semibold text-gray-300">
            New notification
          </span>
          <button
            type="button"
            className="ml-auto -mx-1.5 -my-1.5 bg-gray-800 justify-center items-center flex-shrink-0 text-gray-400 hover:text-gray-300 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-700 inline-flex h-8 w-8"
