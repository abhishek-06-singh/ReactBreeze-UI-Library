      ...
      <div>
        ...
        >
          <button
            ...
            aria-expanded="false"
            className="flex items-center justify-center text-white bg-indigo-600 rounded-full w-14 h-14 hover:bg-indigo-800 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 focus:outline-none dark:focus:ring-indigo-800"
          >
            <PlusSvgIcon />
          ...
          >
            <button className="flex items-center justify-center text-black bg-slate-50 rounded-full w-14 h-14 hover:bg-slate-300">
              <ShareSvgIcon />
            </button>
            <button className="flex items-center justify-center text-black bg-slate-50 rounded-full w-14 h-14 hover:bg-slate-300">
              <PrintSvgIcon />
