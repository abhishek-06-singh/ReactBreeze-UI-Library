...
const BookingDetailsDark = () => {
  ...
  return (
    <div className="relative flex items-center justify-center h-screen bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-100 via-indigo-300 to-pink-300">
      <div className="bg-gray-800 pl-3 pb-3 rounded-xl shadow-md flex flex-col w-2/6 relative">
        {/* <div className="ml-auto cursor-pointer bg-indigo-700 bg-opacity-75 justify-center items-center flex-shrink-0 text-white hover:text-gray-300 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-indigo-600 inline-flex h-8 w-8 z-50">
          <CrossSvgIconWhite />
        </div> */}
        <div className="flex items-center mb-4">
          ...
          <div className="ml-4">
            ...
            <p className="mb-1 text-md font-bold text-indigo-300">
              {BookingProduct.BookingId}
            </p>
            <p className="mb-1 text-md text-white">
              {BookingProduct.date + " " + BookingProduct.time}
            </p>
            <p className="mb-1 text-md text-green-400">
...
export default BookingDetailsDark;
