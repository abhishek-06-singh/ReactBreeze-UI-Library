...
const BookingDetails2Dark = () => {
  ...
  const RatingModal = () => {
    return (
      <div className="fixed top-0 right-0 left-0 bottom-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-slate-900 p-8 rounded-lg w-1/3 text-white">
          ...
          <textarea
            ...
            className="w-full h-20 border border-gray-500 p-2 rounded-md bg-indigo-700 bg-opacity-20"
            placeholder="Type your comments here..."
          />

          <button
            className="mt-3 px-4 py-2 bg-indigo-600 text-white rounded-full transition duration-300 hover:opacity-80 w-full"
  ...
  return (
    <div className="relative flex items-center justify-center h-screen bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-100 via-indigo-300 to-pink-300">
      <div className="relative w-1/3 h-4/6 bg-gray-800 pr-4 pt-4 pl-4 rounded-xl  shadow-slate-50 overflow-hidden">
        {isRatingModalOpen && <RatingModal />}
        <div className="absolute top-1 right-1 cursor-pointer bg-indigo-700 bg-opacity-75 justify-center items-center flex-shrink-0 text-white hover:text-gray-300 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-indigo-600 inline-flex h-8 w-8 z-40">
          <CrossSvgIconWhite />
        </div>
        ...
        <div className="bg-gray-700 p-3 rounded-lg shadow-md">
          <div className="flex mb-4">
            ...
            <div>
              ...
              <p className="text-green-400 mb-1 font-bold">
          ...
          <div className="flex justify-between">
            <button
              className="flex items-center px-4 py-2 bg-indigo-700 text-white w-44 text-center rounded-full mr-2 border-indigo-700 border-opacity-50 transition duration-300 hover:opacity-80"
              onClick={openRatingModal}
            >
              <AiOutlineStar className="mr-2 ml-8" />
              Rate Us
            </button>
            <button className="flex items-center px-5 py-2 bg-indigo-800 w-44 text-white rounded-full transition duration-300 hover:opacity-80">
        ...
        <div className="mt-2 overflow-y-auto p-2 rounded-lg h-1/3 scrollbar-hide">
          <h2 className="text-xl font-bold mb-3 text-slate-50">
            Amount Breakdown
          </h2>
          <div className="flex justify-between mb-4 text-slate-50">
            <p>Price</p>
            <p className="text-green-600">${BookingProduct.price}</p>
          </div>
          <div className="flex justify-between mb-3 text-slate-50">
            <p>Promo Discount</p>
...
export default BookingDetails2Dark;
