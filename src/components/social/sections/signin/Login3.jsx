      ...
      >
        ...
        <div className="p-4 rounded-md text-dark-text w-2/6 relative z-10 mt-36">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-amber-500 text-white p-4 rounded-xl"
            >
              Log In
            </button>
          </form>
        ...
        <div className="bg-amber-50 p-4 rounded-xl text-dark-text w-1/4 relative z-10 mt-4">
