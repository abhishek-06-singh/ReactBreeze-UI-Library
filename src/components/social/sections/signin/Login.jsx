...
// import background from "../../../../assests/images/loginbg.png";
  ...
  return (
    <>
      ...
      >
        ...
        />
        <div className="bg-opacity-30 p-4 rounded-md text-white w-2/6 relative z-10 mt-36">
          <h2 className="text-lr mb-6 text-center ">
        ...
        <div className="bg-gray-400 bg-opacity-5 p-4 rounded-xl text-gray-300 w-2/4 relative z-10 mt-4">
