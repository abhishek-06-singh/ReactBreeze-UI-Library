...
const CommentsModal5 = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-100 via-indigo-300 to-pink-300">
      <div className="bg-white text-black p-4 rounded-xl w-5/12 grid h-3/4 grid-rows-[auto,1fr,auto] gap-4 border-gray-600 relative ">
        ...
        <div className="col-span-2 text-black pl-10 pr-8 overflow-auto max-h-2/4 scrollbar-hide">
          <p>
          ...
          <div className="overflow-auto max-h-40 scrollbar-hide bg-gray-100 mt-3 whitespace-normal">
            {comments.map((comment, index) => (
              <div
                key={index}
                className="flex items-start space-x-4 mt-4 ml-2 border-b border-gray-300 pb-4"
              >
                <img
        ...
        <div className="flex items-center space-x-2">
          ...
          <input
            ...
            className="border border-gray-100 p-2 flex-grow rounded text-black bg-gray-100 w-80"
          />
          <div className="p-2 rounded text-black">
            <label htmlFor="image-upload">
              <FaImage className="text-fuchsia-700" />
            </label>
            <input
              type="file"
              accept="image/*"
        ...
        <div className="flex justify-end mt-2">
          <button
            ...
            className="bg-fuchsia-700 text-white px-2 py-2 rounded-xl w-24"
          >
            Post
          </button>
        </div>
