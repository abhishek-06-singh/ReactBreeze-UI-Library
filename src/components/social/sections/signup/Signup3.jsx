      ...
      >
        <div className="bg-opacity-30 p-4 rounded-md text-black w-2/6 relative z-10 mt-40">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-amber-600 text-white p-4 rounded-xl"
            >
              Sign Up
            </button>
          </form>
        ...
        <div className="p-4 rounded-xl text-gray-300 w-1/4 relative z-10 mt-6 h-16 bg-amber-50">
          <div className="flex items-center justify-between">
            ...
            <FiArrowUpRight className="text-2xl w-8 cursor-pointer text-amber-600" />
          </div>
        </div>
      </div>
    </>
