  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4 rounded-xl text-gray-300 w-1/4 relative z-10 mt-6 h-16 bg-emerald-50">
          <div className="flex items-center justify-between">
            ...
            <FiArrowUpRight className="text-2xl w-8 cursor-pointer text-emerald-600" />
          </div>
        </div>
      </div>
    </>
