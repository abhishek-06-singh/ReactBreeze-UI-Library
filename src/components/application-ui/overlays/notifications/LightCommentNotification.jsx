...
const LightCommentNotification = () => {
              ...
              <div className="p-4">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <p className="text-gray-600">{userNotification.message}</p>
                    <div className="mt-2 flex items-center">
                      <button
                        type="button"
                        className="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-gray-800 bg-indigo-300 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                      >
                        Reply
                      </button>
                    </div>
...
export default LightCommentNotification;
