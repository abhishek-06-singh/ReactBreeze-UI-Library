        ...
        <div class="relative z-10 mt-12 hidden select-none lg:flex">
          <div class="z-20 flex flex-col">
            ...
            <div class="relative ml-6 flex items-center justify-end">
              ...
              <div class="relative p-4">
                <div class="pointer-events-auto rounded-md bg-purple-600 px-3 py-2 text-[0.8125rem] font-semibold leading-5 text-white hover:bg-purple-500">
                  Button A
                </div>
              </div>
              <div class="z-0">
        ...
        <div class="mx-auto max-w-container px-4 pb-16 sm:px-6 lg:px-8">
          <div class="relative mx-auto grid max-w-[40rem] grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-3">
            <div class="flex">
              <div class="p-0.5">
                <svg
                  class="h-10 w-10 shrink-0 transform-cpu rounded-lg shadow-md shadow-purple-500/[.12]"
                  viewBox="0 0 40 40"
                  fill="none"
                  stroke-width="1.5"
                  stroke-linecap="round"
                ...
                >
                  <path
                    ...
                    class="fill-purple-50 stroke-purple-500"
                  ></path>
                  <path
              ...
              <div class="p-0.5">
                ...
                >
                  ...
                  <path
                    ...
                    class="stroke-purple-500/50"
                  ></path>
                  <path d="M31.5 8.5l-23 23" class="stroke-purple-500"></path>
                  <path
