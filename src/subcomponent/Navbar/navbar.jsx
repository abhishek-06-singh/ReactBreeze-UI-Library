...
import Logo from "../../components/social/assets/appLogowhite.png";
const Navbar = () => {
  return (
    <>
      <header className="relative z-50 w-full flex-none text-sm font-semibold leading-6 text-slate-900 bg-zinc-900 ">
        <nav
          aria-label="Global"
          className="mx-auto max-w-container px-4 sm:px-6 lg:px-8 pt-6"
        >
          <div className="relative flex items-center ">
            ...
            >
              <svg className="h-4 w-4 fill-indigo-500" viewBox="0 0 24 24">
                <path
                  fill-rule="evenodd"
              ...
              <svg
                viewBox="0 0 5 8"
                className="h-2 w-[5px] fill-state-100 group-hover:fill-black/60"
                fill-rule="evenodd"
                clip-rule="evenodd"
                aria-hidden="true"
              >
